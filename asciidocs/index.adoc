...
** Es ist eine Liste mit RecycleView in ANdroid zu erstellen
...
** In der ORacle VM ist ein Quarkus-Restful-Service zu erstellen (mit automatiserter Pipeline)
*** passend zum Microprojekt
*** verwenden Sie hierzu Ihr https://classroom.github.com/classrooms/71467635-2021-4ahif-nvs/assignments/microproject[quarkus-microproject]
